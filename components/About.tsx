      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <ScrollReveal direction="up" delay={200}>
            <div className="grid md:grid-cols-3 gap-12 mt-16 pt-16 border-t border-border-default">
              <div>
                <h3 className="text-2xl font-light mb-4 text-text-primary">Our Mission</h3>
              ...
              <div>
                <h3 className="text-2xl font-light mb-4 text-text-primary">Our Values</h3>
                <p className="text-text-secondary leading-relaxed font-light">
                  Simplicity, clarity, and attention to detail guide everything we do. We believe in doing less, but doing it better.
                </p>
              </div>
              <div>
                <h3 className="text-2xl font-light mb-4 text-text-primary">Our Approach</h3>
                <p className="text-text-secondary leading-relaxed font-light">
